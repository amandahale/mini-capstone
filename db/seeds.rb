...
User.create!([
  {name: "Luna", email: "luna@gmail.com", password_digest: "$2a$10$Z7nTQk8u0ZPL.CAHGPrzKucRB5ArMqvcjfzfLcZuYWwVfqiMUhKwe", admin: false},
  {name: "Amanda", email: "amanda@gmail.com", password_digest: "$2a$10$iQcjU.Fqng6zkKEEFuszk./TO6SSz6iXGfM13IKdi/.ZDhwTLXery", admin: false}
])

Product.create!([
  {name: "Cloud Pink Lolly Roller Skates", price: "250.0", description: "Moxi's dreamy lolly suede boot in the lovely shade of 'Cloud Pink'", supplier_id: 1},
  {name: "Skate Leash", price: "14.0", description: "Perfect for bringing your skates along when you're not on wheels.", supplier_id: 3},
  {name: "Gummy Outdoor Wheels", price: "42.0", description: "These wheels are perfect for outdoor skating stability and grip. Sold as a four pack, 78A.", supplier_id: 2}
])
...
Order.create!([
  {user_id: 2, subtotal: "336.0", tax: "30.24", total: "366.24"},
  {user_id: 2, subtotal: "1250.0", tax: "112.5", total: "1362.5"},
  {user_id: 2, subtotal: "1400.0", tax: "126.0", total: "1526.0"}
])
Image.create!([
